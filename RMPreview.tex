...
\newcommand{\ilya}[1]{\textcolor{blue}{{\it Ilya to Alison:} #1}}
...
\textcolor{red}{Section needs an intro.}  \ilya{Isn't the paragraph that follows an intro?  I hoped it would serve that purpose...}
...
The short answer is that the masses themselves should not be surprising, and we will return to the masses (and spins) later. On the other hand, perhaps the very existence of merging neutron stars and black holes should be.   In fact, we might formulate a ``fundamental theorem of gravitational-wave astrophysics'': it is challenging to bring compact objects to merge within the age of the Universe.  And this one boils down to their separation.  
%erhaps the key problem of gravitational-wave astronomy, is why compact object binaries ever merge at all.  
...
\subsection{Understanding the masses of the merging black holes}
...
\subsection{Merging black hole spins}
...
\subsection{Merging black hole environments and delay times}
...
\subsection{Merging black hole eccentricities}
